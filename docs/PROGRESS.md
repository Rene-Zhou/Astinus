...
| 任务 | 优先级 | 状态 | 文件 |
|------|--------|------|------|
| 6.2.1 数据库服务 | 🔴 Critical | ⏳ 待开始 | `src/backend/services/database.py` (新) |
| 6.2.2 会话管理 | 🔴 Critical | ⏳ 待开始 | `src/backend/services/session.py` (新) |
| 6.2.3 持久化模型 | 🔴 Critical | ⏳ 待开始 | `src/backend/models/persistence.py` (新) |
| 6.2.4 存档 API | 🟡 High | ⏳ 待开始 | `src/backend/api/v1/game.py` |
| 6.2.5 自动存档 | 🟡 High | ⏳ 待开始 | `src/backend/services/session.py` |

**说明**:
- SQLite 连接管理与会话 CRUD
- SQLAlchemy 持久化模型
- 新增 save/load/list 端点
- 定期自动保存机制
...
| 任务 | 优先级 | 状态 | 文件 |
|------|--------|------|------|
| 6.3.1 开始菜单 | 🟡 High | ⏳ 待开始 | `src/frontend/screens/menu_screen.py` (新) |
| 6.3.2 角色创建 | 🟡 High | ⏳ 待开始 | `src/frontend/screens/character_creation.py` (新) |
| 6.3.3 状态显示增强 | 🟡 High | ⏳ 待开始 | `src/frontend/widgets/stat_block.py` |
...
#### Phase 6.4: Agent 协作完善 ⏳ 待开始
| 任务 | 优先级 | 状态 | 文件 |
|------|--------|------|------|
| 6.4.1 GM Agent 路由 | 🟡 High | ⏳ 待开始 | `src/backend/agents/gm.py` |
| 6.4.2 NPC 状态更新 | 🟡 High | ⏳ 待开始 | `src/backend/agents/npc.py` |
| 6.4.3 Rule Agent 结果处理 | 🟡 High | ⏳ 待开始 | `src/backend/agents/rule.py` |
| 6.4.4 Director Agent | 🟢 Medium | ⏳ 待开始 | `src/backend/agents/director.py` (新) |
